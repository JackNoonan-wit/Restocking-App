...
fun mainMenu() : Int {
    return ScannerInput.readNextInt("""
        ...
        >        //    """+red+"""_/_/_/_/_/  _/_/_/_/    _/_/_/    _/_/_/    _/_/"""+reset+"""   \\ 
        >       //        """+red+"""_/      _/        _/        _/        _/    _/"""+reset+"""   \\
        >      //        """+red+"""_/      _/_/_/      _/_/    _/        _/    _/"""+reset+"""     \\
        >     //        """+red+"""_/      _/              _/  _/        _/    _/"""+reset+"""       \\
        >    //        """+red+"""_/      _/_/_/_/  _/_/_/      _/_/_/    _/_/"""+reset+"""           \\ 
        >   //       """+blue+""" ____/     ____/     ____/      ____/      ____/"""+reset+"""          \\
        >  //__________________________________________________________________ \\ 
        >  ||                                                                    ||
        >  ||                      """+red+"""RESTOCKING APPLICATION"""+reset+"""                        ||
        >  ||                                                                    ||
        >  ||      """+red+"""1) """+blue+"""Branch Options                    """+red+"""3) """+blue+"""Search Options"""+reset+"""        ||
        >  ||                                                                    ||
        >  ||                            __________                              ||
        >  ||      """+red+"""2) """+blue+"""List Options"""+reset+"""       | | || | |     """+red+"""0) """+blue+"""Exit"""+reset+"""                  ||
        >           ||                            | | || | |                              ||
        >           [][][][][[][][][][][][][][][][][][][][][][][][][][][][][][][][][][][][]
|
   ==>> """.trimMargin(">"))
...
fun branchOptions(){
    ...
    val option = readNextInt("""
        ...
        >  //__________________________________________________________________ \\ 
        >  ||                                                                    ||
        >  ||                      """+red+"""Branch Options"""+reset+"""                                ||
        >  ||                                                                    ||
        >  ||      """+red+"""1) """+blue+"""Add New Branch                   """+red+"""3) """+blue+"""Remove Branch"""+reset+"""          ||
        >  ||                                                                    ||
        >  ||                            __________                              ||
        >  ||      """+red+"""2) """+blue+"""Update Branch"""+reset+"""       | | || | |     """+red+"""0) """+blue+"""Product Options"""+reset+"""      ||
        >           ||                            | | || | |                              ||
        >           [][][][][[][][][][][][][][][][][][][][][][][][][][][][][][][][][][][][]
|
   ==>> """.trimMargin(">"))
...
fun productOptions(){
    val option = readNextInt("""
        ...
        >  //__________________________________________________________________ \\ 
        >  ||                                                                    ||
        >  ||                      """+red+"""Product Options"""+reset+"""                               ||
        >  ||                                                                    ||
        >  ||      """+red+"""1) """+blue+"""Add New Product                   """+red+"""3) """+blue+"""Remove Product"""+reset+"""        ||
        >  ||                                                                    ||
        >  ||                            __________                              ||
        >  ||      """+red+"""2) """+blue+"""Update Product"""+reset+"""       | | || | |     """+red+""" """+blue+""""""+reset+"""                    ||
        >           ||                            | | || | |                              ||
        >           [][][][][[][][][][][][][][][][][][][][][][][][][][][][][][][][][][][][]
|
   ==>> """.trimMargin(">"))
...
fun searchOptions(){
    if (branchAPI.numberOfBranches() > 0) {
        ...
        >  ||                      """+red+"""Branch Options"""+reset+"""                                ||
        >  ||                                                                    ||
        >  ||      """+red+"""1) """+blue+"""Search By Name                  """+red+"""3) """+blue+"""Search By Location"""+reset+"""      ||
        >  ||                                                                    ||
        >  ||                            __________                              ||
        >  ||      """+red+"""2) """+blue+"""Search By Manager"""+reset+"""  | | || | |     """+red+""""""+blue+""""""+reset+"""                         ||
        >           ||                            | | || | |                              ||
        >           [][][][][[][][][][][][][][][][][][][][][][][][][][][][][][][][][][][][]
|
   ==>> """.trimMargin(">"))
